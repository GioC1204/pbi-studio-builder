...
const AccessPreview = ({ profile, criterion }) => {
  if (profile.all_access) {
    return (
      <div className="mt-2 bg-surface-50 border border-surface-100 rounded-lg px-3 py-2 text-xs text-surface-600 leading-relaxed">
        <strong className="text-surface-900">👤 director@empresa.com</strong> → verá <strong className="text-surface-900">todos los datos</strong><br />
  ...
  return (
    <div className="mt-2 bg-surface-50 border border-surface-100 rounded-lg px-3 py-2 text-xs text-surface-600 leading-relaxed">
      <strong className="text-surface-900">👤 ana@empresa.com</strong> → verá solo sus datos de <strong className="text-surface-900">{criterion}</strong><br />
